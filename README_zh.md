...
<a href="docs/media/hero.mp4"><img src="docs/media/hero-poster.png" width="300" alt="观看演示"></a>

*▶ 说一个任务,看 Claude Code 在绿屏 HUD 上把它做完——危险操作靠手势确认。(点击播放)* · [English README](README.md)
...
<a href="docs/media/switchmodel.mp4"><img src="docs/media/switchmodel-poster.png" width="300" alt="语音切模型 — 点击播放"></a>

**运行时切语言** —— 说「switch language」,整屏 HUD 在中英之间瞬切:

<a href="docs/media/switchlanguage.mp4"><img src="docs/media/switchlanguage-poster.png" width="300" alt="运行时切语言 — 点击播放"></a>
