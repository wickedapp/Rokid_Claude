...
data class Strings(
    ...
    val stopSegment: String,
    val listening: String,
    val dictationReview: String,
    val sendPreview: String,
    val currentCandidate: String,
    val continueAction: String,
    val redo: String,
    val cancelSegment: String,
)
...
private val ZH_CN = Strings(
    ...
    newOpenCodeSession = "+ 新建 OpenCode 会话",
    ...
    creatingCodex = "正在创建 Codex 会话", creatingOpenCode = "正在创建 OpenCode 会话",
    aoeError = "AOE 错误", emptyReply = "回复内容为空",
    sending = "正在发送…", sessionFallback = "会话", statusRunning = "运行", statusIdle = "空闲",
    statusStopped = "已停止", statusError = "错误", open = "打开", create = "新建", send = "发送",
    scroll = "滚动", select = "选择", sessions = "会话",
    confirmAction = "确认", stopSegment = "停止本段", listening = "聆听中", dictationReview = "核对本段",
    sendPreview = "发送预览", currentCandidate = "本段识别结果", continueAction = "继续", redo = "重录",
    cancelSegment = "取消本段",
)
...
private val EN = Strings(
    ...
    creatingCodex = "Creating Codex session", creatingOpenCode = "Creating OpenCode session",
    aoeError = "AOE error", emptyReply = "Reply is empty",
    sending = "Sending…", sessionFallback = "Session", statusRunning = "Running", statusIdle = "Idle",
    statusStopped = "Stopped", statusError = "Error", open = "Open", create = "New", send = "Send",
    scroll = "Scroll", select = "Select", sessions = "Sessions",
    confirmAction = "Confirm", stopSegment = "Stop Segment", listening = "Listening", dictationReview = "Review Segment",
    sendPreview = "Send Preview", currentCandidate = "Current Candidate", continueAction = "Continue", redo = "Redo",
    cancelSegment = "Cancel Segment",
)
